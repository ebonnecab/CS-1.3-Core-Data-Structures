...
class StringsTest(unittest.TestCase):
    ...
    def test_contains_with_matching_patterns(self):
        ...
        assert contains('rare', 're') is True
        assert contains('ebonne', 'e') is True
    ...
    def test_contains_with_non_matching_patterns(self):
        ...
        assert contains ('xyz', 'abc') is False
        assert contains('ebonne', 'neb') is False
    ...
    def test_contains_with_complex_patterns(self):
        ...
        assert contains('cabarrus', 'rus') is True
        assert contains('ababababa', 'bab') is True
    ...
    def test_find_index_with_matching_patterns(self):
        ...
        assert find_index('ebo', 'e') == 0
        assert find_index('test', 'es') == 1
    ...
    def test_find_index_with_non_matching_patterns(self):
        ...
        assert find_index('abcd', 'da') is None
        assert find_index('ab', 'c') is None
    ...
    def test_find_index_with_complex_patterns(self):
        ...
        assert find_index('abababababa', 'ab') == 0
        assert find_index('za za zac', 'zac') == 6
    ...
    def test_find_all_indexes_with_matching_patterns(self):
        ...
        assert find_all_indexes('abcd', 'abcd') == [0]
        assert find_all_indexes('cab', 'ab') == [1,2]
    ...
    def test_find_all_indexes_with_non_matching_patterns(self):
        ...
        assert find_all_indexes('abcd', 'cda') == []
        assert find_all_indexes('ace', 'eca') == []
    ...
    def test_find_all_indexes_with_complex_patterns(self):
        ...
        assert find_all_indexes('ebonne', 'n') == [3, 4]
        assert find_all_indexes('eeeeee', 'e') == [0,1,2,3,4,5]
